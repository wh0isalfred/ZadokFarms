...
Review the staff access and read-only Orders foundation documented at the end of this file. Follow STAFF_AUTH_RUNBOOK.md for owner-controlled Auth configuration/provisioning before rollout. The customer WhatsApp confirmation milestone is already on main; its approved business destination still requires deployment configuration.
